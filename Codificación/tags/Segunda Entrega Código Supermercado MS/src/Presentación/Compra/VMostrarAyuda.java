...
public class VMostrarAyuda extends JDialog implements ActionListener, IGUI {
	...
	public void init_GUI() {
		...
		labelText1.setText(
				"<html>Al pulsar '<i>Añadir</i>', se agregará el producto deseado al carrito de la compra, <br>aumentando la cantidad correspondiente al precio de la compra total.</html>");
		panel1.add(Box.createRigidArea(new Dimension(10, 80)));
		panel1.add(labelIcon1);
		panel1.add(labelText1);

		labelText2.setText(
				"<html>Al pulsar '<i>Delete</i>', se borrará el producto del carrito de la compra, <br>restando la cantidad correspondiente al precio de la compra total.</html>");
		panel2.add(Box.createRigidArea(new Dimension(10, 80)));
		panel2.add(labelIcon2);
		panel2.add(labelText2);

		labelText3.setText(
				"<html>Al pulsar '<i>Pagar</i>', se pasará a efectuar la compra, <br>asegúrese de tener suficiente dinero.</html>");
