...
public class BuscarComprasPorRangoPrecioFechaCommand implements Command{
	...
	public Context executeCommand(Object datos) {
		...
		List<TCompra> compras = FactoriaSA.getInstance().getSACompra().buscarComprasPorRangoPrecioFecha((int) args.get("desdePrecio"), (int) args.get("hastaPrecio"),(LocalDate) args.get("desdeFecha"),(LocalDate) args.get("hastaFecha"));
		Context resContext;
