...
public class VMostrarAyudaSuper extends JDialog implements ActionListener, IGUI {
	...
	public VMostrarAyudaSuper() {
		...
		generalPanel.setBackground(new Color(39, 174, 95));

		panel1 = new JPanel(new FlowLayout(FlowLayout.LEFT));
		panel1.setBackground(new Color(39, 174, 95));
		...
		panel3.setBackground(new Color(39, 174, 95));
