...
public class FormComponent extends JPanel {
	...
	public FormComponent(ArrayList<String> names, String title, ArrayList<JTextField> textFields,
	...
	public void setSubmitButtonColor(Color new_color){
		submitButton.setBackground(new_color);
	}
}
